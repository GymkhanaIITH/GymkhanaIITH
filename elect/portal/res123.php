...
?>
  <table class="table table-bordered">
      <thead><tr><th colspan="100%"><strong><center><?php
    echo $d[0] . " (Total Votes - " . $count . ")"; ?></center></strong></th></tr></thead>
      <tbody>
          <tr>
<?php
    $pref1 = [];
...
<?php
    if (count($pref1) == 1)
      {
      if (in_array($d[1], $disqualified)) echo "<strong>" . $d[2] . " won</strong>";
        else echo "<strong>" . $d[1] . " won</strong>";
      }
